...
function BurgerMenuPopup(props) {
  console.log(props);
  return (
    <div className={`burgerMenuPopup__popup ${props.isBurgerOpened ? "burgerMenuPopup__popup_opened" : ""}`}>
      <div className="burgerMenuPopup__container">
        <button type="button" className="burgerMenuPopup__close-button" onClick={props.onClose}>&#10006;</button>
